...
1. Please bring a laptop that has the following installed:
    ...
    ```
    + Note: On RStudio cloud I have installed the latest version of the `survival` package (3.0.11).  It has been submitted to CRAN and hopefully will available shortly.
